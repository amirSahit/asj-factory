function CompanyOrganogram() {
  return (
    <article className="flex flex-col items-center gap-2 text-xl">
      ...
      <figure className="relative">
        ...
        />
        <figcaption className="absolute bottom-44 left-0 bg-blue p-4 w-[250px] text-white text-center text-xl">
